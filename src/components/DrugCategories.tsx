  ...
  return (
    <Container className="bg-gray-100 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h3 className="text-2xl font-semibold text-center mb-6">SOME OF OUR BEST SELLING DRUG CATEGORIES</h3>
        <p className="text-center text-gray-600 mb-8">We always maintain the quality and efficacy</p>
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4">
          <div className="flex flex-col items-center text-center space-y-2">
            ...
            <p className="text-sm">
              ...
              type of antibacterial agent for fighting bacterial infections.
            </p>
          </div>
          <div className="flex flex-col items-center text-center space-y-2">
            <PlusIcon className="text-blue-600 h-8 w-8" />
            ...
            <p className="text-sm">
              ...
              suffering and improving the quality of life of those living with chronic pain.
            </p>
          </div>
          <div className="flex flex-col items-center text-center space-y-2">
            <PlusIcon className="text-blue-600 h-8 w-8" />
            ...
            <p className="text-sm">
              ...
              calcium, magnesium, and phosphate, and many other biological effects.
            </p>
          </div>
        </div>
      </div>
