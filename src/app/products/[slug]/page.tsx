...
import { Product, productCategory, productComposition } from '@/lib/products';
  ...
  return (
    <main id='main-content' className='shell detail-page'>
      ...
      <nav aria-label='Breadcrumb' className='breadcrumb'>
        ...
        <span aria-hidden='true'>/</span>
        <span aria-current='page'>{product.heading}</span>
      </nav>
      <div className='detail-layout'>
        ...
        <div className='detail-summary'>
          ...
          <p className='intro'>{product.desc || product.tagline}</p>
          <dl className='detail-facts'>
            ...
            <div>
              <dt>Brand</dt>
              <dd>TrPharma · ThinkRoman Ventures</dd>
            </div>
          </dl>
          <a className='text-link' href='#product-information'>
            Read product information ↓
          </a>
          <br />
          <Link
            className='button button-outline'
            href='/contact-us#professionals'
          >
            Enquire about this product <ArrowUpRight size={18} />
          </Link>
        </div>
      </div>
      <section id='product-information' className='detail-info'>
        <aside className='detail-sidebar'>
          <p className='eyebrow'>KNOW YOUR PRODUCT</p>
          <h2>
            Product
            <br />
            information
